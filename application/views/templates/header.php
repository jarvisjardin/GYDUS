        ...
        <section class="navbar  navbar-fixed-top ">
            <section class="navbar-inner dark-header">
                ...
                <section class="logo" id="logo">
                    <a id='gydusHeader' class="brand gydus-logo" data-toggle="dropdown" href="#">
                        <img src="<?php echo base_url();?>/webroot/img/logo_smaller-01.png" alt="Gydus" />
                    </a>
                    <ul class="gydusSetDrop dropdown-menu">
                        <li class="gydusContactHead">
                            <a href="<?php echo base_url();?>index.php/userController/contact_us">
                                <h3>Contact Us</h3>
                            </a>
                        </li>
                        <li class="gydusDevCornerHead">
                            <a href="<?php echo base_url();?>index.php/userController/dev_corner">
                                <h3>Developers Corner</h3>
                            </a>
                        </li>
                        <li class="gydusTermsHead">
                            <a href="#">
                ...
                <section class="gydus-signin-nav pull-right">
                    <a class="brand signin nav-signin" data-toggle="dropdown" href="#"><span class="dbName"><?php echo $userData['name'];?></span>
                    </a>
                    <ul class="gydusUserDrop dropdown-menu">
                        <li class="accountSettingsHead ">
                            <a href="<?php echo base_url();?>index.php/userController/account_setting">
                                <h3>Account Settings</h3>
                            </a>
                        </li>
                        <li class="logOutaccountSettingsHead btn-danger">
                ...
                <!-- end of gydus signin nav-->
            </section>
            <!-- close navbar-inner dark-header -->
        </section>
        <!-- end of navbar navbar-fixed-top -->
        <? }else{ ?>
        <!-- NAVIGATION -->
        <section class="navbar  navbar-fixed-top ">
            <section class="navbar-inner dark-header">
